...
$tokensTemplate = __DIR__ . '/tokens.template.php';
$skeletonFile   = __DIR__ . '/parser.template.php';
$tmpGrammarFile = __DIR__ . '/tmp_parser.phpy';
$tmpResultFile  = __DIR__ . '/tmp_parser.php';
$resultDir = __DIR__ . '/../lib/Parser';
...
echo "Building temporary language grammar file.\n";

$grammarCode = file_get_contents(__DIR__ . '/language.y');
...
$output = trim(shell_exec("$kmyacc $additionalArgs -l -m $skeletonFile -p Parser $tmpGrammarFile 2>&1"));
echo "Output: \"$output\"\n";
...
file_put_contents("$resultDir/Parser.php", $resultCode);
